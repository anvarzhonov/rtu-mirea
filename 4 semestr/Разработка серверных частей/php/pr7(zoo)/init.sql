...
INSERT INTO person (login, password, privelegy) 
SELECT * FROM (SELECT 'admin', 'admin', 1) AS tmp
WHERE NOT EXISTS (
    SELECT login FROM person WHERE login = 'admin' AND password = 'admin' AND privelegy = 1
) LIMIT 1;

INSERT INTO person (login, password, privelegy) 
SELECT * FROM (SELECT 'ivan', '202cb962ac59075b964b07152d234b70', 0) AS tmp
WHERE NOT EXISTS (
    SELECT login FROM person WHERE login = 'ivan' AND password = '202cb962ac59075b964b07152d234b70' AND privelegy = 0
) LIMIT 1;