...
<html lang="en">
  ...
  <body>
    ...
    <div class="p-3 fixed-bottom border">
      <div class="text-center">
        <a href="http://localhost:8001/about.html" class="lead">О ресторане</a>
      </div>
      <div class="text-center">
        <a href="http://localhost:8001/dresscode.html" class="lead">Дресс-код</a>
      </div>
    </div>
  </body>
</html>
